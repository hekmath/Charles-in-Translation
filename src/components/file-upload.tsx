      ...
      >
        ...
        <div className="p-12 text-center space-y-6">
          ...
          <div className="relative mx-auto w-20 h-20">
            ...
            <div className="relative w-full h-full bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center shadow-lg">
              <svg
        ...
        <div className="absolute bottom-4 left-4 w-6 h-6 bg-secondary/10 rounded-full animate-pulse delay-1000"></div>
      </div>
    </Card>
  );
}
